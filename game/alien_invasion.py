...
class AlienInvasion:
    # class to control of resource and game

    def __init__(self):
        # init game and create resource of game
        pygame.init()
        ...
        # creating instances for storing statistics and the results pane
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            # decreasing ships_left and updating scoreboard
    ...
    def _fire_bullet(self):
        # create a new projectile and including it in the bullet group
        if len(self.bullets) < self.settings.bullets_allowed:
            new_bullet = Bullet(self)
            self.bullets.add(new_bullet)

    def _update_bullets(self):
        # updates projectile positions and removes old projectiles
    ...
    def _check_bullet_alien_collisions(self):
        # handling collisions of projectiles with aliens
...
if __name__ == '__main__':
    # create instantion and run the game
    ai = AlienInvasion()
    ai.run_game()
